...
class AddPlane:
    ...
    def create_plane(self,spd,dist,plane_trajectory,plane_1,plane_2,plane_3,
        plane_4,plane_5,num,distance,height,speed,dotted_index,dot,frame_amount):
        ...
        spd.set_data(self.t[0:num],speed[0:num])

    def initialize_stuff(self,ax,color):

        plane_trajectory,=ax.plot([],[],color,linewidth=2)
        # Initialize airplane
